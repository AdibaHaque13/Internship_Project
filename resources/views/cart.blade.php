                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <form action="{{URL::to('updateCart')}}" method="POST">
                                        @csrf
                                        <div class="quantity">
                                            <input type="number" class="form-control" max="{{$item->pQuantity}}" name="quantity" min="1" value="{{$item->quantity}}">
                                        </div>
                    ...
                    <div class="cart__total">
                        ...
                        <ul>
                         ...
                         <form action="{{URL::to('checkout')}}">
                            ...
                            <input type="submit" name="checkout" class="primary-btn mt-2" value="Proceed to checkout" id="" >
                        </form>
